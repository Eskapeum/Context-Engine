/**
 * Universal Context Memory - Context Generator
 *
 * Generates tool-specific context files from the project index.
 * Creates UCM.md, CONTEXT.md, CLAUDE.md, .cursorrules, and copilot-instructions.md
 *
 * @module generator
 */
...
> Auto-generated by Universal Context Memory (UCM) v${index.ucmVersion}
...
> Generated by Universal Context Memory (UCM) v${index.ucmVersion}
...
---
*This file is auto-generated by Universal Context Memory (UCM) v${index.ucmVersion}*
...
/**
 * Generate universal UCM.md - the primary context file for any AI assistant
 */
export function generateUcmMd(config: GeneratorConfig): string {
  const { index } = config;
...
---
*Auto-generated by [Universal Context Memory](https://github.com/Eskapeum/Context-Memory) v${index.ucmVersion}*
...
export class ContextGenerator {
  ...
  public generateAll(): void {
    ...
    // Generate UCM.md (primary universal context file)
    const ucmMd = generateUcmMd(this.config);
    fs.writeFileSync(path.join(projectRoot, 'UCM.md'), ucmMd);
   ...
   */
  public generate(target: 'ucm' | 'context' | 'claude' | 'cursor' | 'copilot'): string {
    switch (target) {
      case 'ucm':
        return generateUcmMd(this.config);
      case 'context':
